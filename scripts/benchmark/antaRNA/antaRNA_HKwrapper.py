...
def ant_exe(params) :
    cmd = "python antarna.py -tGC {}  -t {} MFE -Cstr '{}' -p -HKPATH '/usr/people/nonosaha/Softwares/HotKnots_v2.0/bin' --pkprogram={} "
...
def pp_antRNA(target,time, tGC, nb_runs,  ft="IPKnot") : 
...
def parse_arguments():
    ...
    parser.add_argument('--ft', '-ft',type= str ,help="Folding tool ", default="IPKnot")
